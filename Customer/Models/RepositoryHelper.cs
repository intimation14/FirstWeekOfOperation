namespace Customer.Models
{
	public static class RepositoryHelper
	{
		...
		public static vw_CustomerCountRepository Getvw_CustomerCountRepository()
		{
			var repository = new vw_CustomerCountRepository();
			repository.UnitOfWork = GetUnitOfWork();
			return repository;
		}

		public static vw_CustomerCountRepository Getvw_CustomerCountRepository(IUnitOfWork unitOfWork)
		{
			var repository = new vw_CustomerCountRepository();
